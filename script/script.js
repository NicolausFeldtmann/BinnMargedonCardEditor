...
function renderCards() {
    ...
    contentRef.innerHTML = "";
        for (let i = 0; i < dataCard.length; i++) {
            ...
            contentRef.innerHTML += getCardTemplate(fracName, charName, tempo1, tempo2, tempo3, unit1, unit2, unit3, am1, am2, am3, lp1, lp2, lp3, waff1, waff2, waff3, waff4, waff5, waffName1, waffName2, waffName3, waffName4, waffName5, dc1, dc2, dc3, dc4, dc5, dc6, dc7, dc8, i);
